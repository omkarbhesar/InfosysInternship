...
function Home() {
  ...
  return (
   ...
   <div className="p-20 mb-10 bg-black text-white">
      ...
      Workfolio
      <button  type="button"onClick={handleButtonClick} className="btn btn-outline-dark">Login</button>
    </a>
  </div>
...
<div className="footer">
     <div className="footer-content">
       ...
       <div className="footer-social">
        <a href="https:www.facebook.com/" target='_blank' className='social-button facebook' id='facebook'>
